<template>
  <div id="about" ref="about" class="h-screen w-full bg-white">
    <!-- Headline -->
    ...
    >
      ...
      >
        <h2
          ref="about-heading"
          class="text-xl font-semibold text-center border-b-2 border-dashed border-gray-700"
        >
    ...
    >
      <div
        v-show="slideIn"
        class="text-center px-2 pt-4 overflow-hidden"
        style="height: 20%"
      >
        <h3 class="text-lg font-semibold">A little bit about me</h3>
        <p class="pt-2 text-sm">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi qui
          rerum est hic ad harum necessitatibus iste? Ipsam voluptatibus
    ...
    >
      <div
        v-show="slideIn"
        class="px-2 pt-2 overflow-hidden"
        style="height: 55%"
      >
        <h3 class="text-lg font-semibold pb-2 text-center">
          Skills and Expertise
        </h3>
        <div
          class="bg-gray-100 flex flex-wrap border border-solid border-gray-600 overflow-hidden"
          style="height: 90%"
        >
          <button
            :class="
              selectedSkillsTab !== 'core'
                ...
                : 'font-semibold'
            "
            class="w-1/3 text-center py-1 px-1 text-md focus:outline-none text-sm"
          ...
          <div class="w-full p-2 overflow-hidden relative" style="height: 80%">
            <transition
            ...
            >
              <div
                ...
                class="absolute h-full w-full overflow-auto"
              >
                <ul
                  class="py-1 text-xs flex flex-col justify-center h-full w-full space-y-1"
                >
                  <li
            ...
            >
              <div
                ...
                class="absolute h-full overflow-auto w-full"
              >
                <ul
                  class="py-1 text-xs flex flex-col justify-center h-full w-full space-y-1"
                >
    ...
    <div style="height: 12%" class="flex flex-col justify-center items-center">
      <transition
        name="about-arrow"
  ...
  mounted() {
    ...
    window.addEventListener('scroll', () => {
      ...
      if (aboutHeading) {
        ...
        if (marginTopHeading - innerHeight < -(innerHeight / 2)) {
          this.slideIn = true
